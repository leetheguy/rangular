...
And some data has already been retrieved for you.  
Namely the index and a new Note to be used in a form.  

You can see the index data by dropping this into your html:  
